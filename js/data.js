...
const NOTABLE_SUBDOMAINS = [
  { t: 'Narrow Finetuning Leaves Clearly Readable Traces in Activation Differences', d: 'Interpretability', u: 'https://openreview.net/forum?id=qyVzZsrsnS' },
  { t: 'Erase or Hide? Suppressing Spurious Unlearning Neurons for Robust Unlearning', d: 'Alignment Training', u: 'https://openreview.net/forum?id=z2zFk9jYpw' },
  { t: 'DiffuGuard: How Intrinsic Safety is Lost and Found in Diffusion Large Language Models', d: 'Adversarial Robustness', u: 'https://openreview.net/forum?id=zBPzxhso8M' },
  { t: 'Watch your steps: Dormant Adversarial Behaviors that Activate upon LLM Finetuning', d: 'Red-Teaming', u: 'https://openreview.net/forum?id=yfM2e8Icsw' },
  { t: 'Grounding Generative Planners in Verifiable Logic: A Hybrid Architecture for Trustworthy Embodied AI', d: 'Safeguards', u: 'https://openreview.net/forum?id=wb05ver1k8' },
  { t: 'PluriHarms: Benchmarking the Full Spectrum of Human Judgments on AI Harm', d: 'Scalable Oversight', u: 'https://openreview.net/forum?id=u7lXflJQX9' },
  { t: 'How Catastrophic is Your LLM? Certifying Risks in Conversation', d: 'Dangerous Capability Evals', u: 'https://openreview.net/forum?id=yt9TW2WtpG' },
  { t: 'Obfuscated Activations Bypass LLM Latent-Space Defenses', d: 'Monitoring', u: 'https://openreview.net/forum?id=ktGmDGoWnB' },
  { t: 'Evolving Interpretable Constitutions for Multi-Agent Coordination', d: 'Multi-Agent Safety', u: 'https://icml.cc/virtual/2026/poster/66529' },
  { t: 'PropensityBench: Evaluating Latent Safety Risks in Large Language Models via an Agentic Approach', d: 'Scheming and Deception', u: 'https://openreview.net/forum?id=jOTQupHx7q' },
  { t: 'Corrigibility Transformation: Constructing Goals That Accept Updates', d: 'Agent Foundations', u: 'https://icml.cc/virtual/2026/poster/64539' },
  { t: 'Tools for Verifying Neural Models\' Training Data', d: 'Policy and Governance', u: 'https://openreview.net/forum?id=TwLHB8sKme' },
  { t: 'Adaptive Attacks on Trusted Monitors Subvert AI Control Protocols', d: 'Control', u: 'https://openreview.net/forum?id=wSs1Ez3aKl' },
  { t: 'A Black Swan Hypothesis: The Role of Human Irrationality in AI Safety', d: 'Strategy and Forecasting', u: 'https://openreview.net/forum?id=7k4HVhUS9k' },
  { t: 'Exploration Hacking: LLMs Can Learn to Resist RL Training', d: 'Model Organisms', u: 'https://icml.cc/virtual/2026/poster/64674' },
  { t: 'GeneBreaker: Jailbreak Attacks against DNA Language Models with Pathogenicity Guidance', d: 'Biorisk', u: 'https://openreview.net/forum?id=C5OIolrNJd' },
  { t: 'Position: Enforced Amnesia as a Way to Mitigate the Potential Risk of Silent Suffering in the Conscious AI', d: 'AI Welfare', u: 'https://openreview.net/forum?id=nACGn4US1R' },
];
const NOTABLE_SCORE = [
...
const VIEWS = {
  ...
  conferences: {
    ...
    brief: 'Across the three largest machine-learning conferences — ICLR, ICML and NeurIPS — the share of accepted papers devoted to AI safety has grown almost thirty-fold since 2019, from 0.3% to 8.3% of everything published in 2026. No single conference runs higher than ICML 2026, at 8.9%.',
    stats: [{ k: 'Conference-years', v: '23' }, { k: 'Total papers', v: '55,794' }, { k: 'Safety papers', v: '2,328' }],
    type: 'vbar', entries: BY_YEAR, suf: '%',
    note: 'Figures combine ICLR, ICML and NeurIPS. NeurIPS 2026 has not taken place yet, so the 2026 point reflects only ICLR and ICML.',
  },
  arxiv: {
    ...
    brief: 'To follow the whole field rather than a handful of conferences, a fast keyword-based model scans every AI paper posted to arXiv and flags the safety-related ones. It is less precise than the main classifier (around 72% precision and 74% recall), so read the line as an approximate trend — but the direction is unmistakable: safety work grew from 0.4% of AI papers in 2019 to more than 9% by 2026.',
  ...
  subdomains: {
    ...
    brief: 'Every safety paper is sorted into one of seventeen research areas. Across all 2,328 of them, Interpretability, Alignment Training and Adversarial Robustness are the largest — together roughly three-fifths of the field. Use BY YEAR to focus on a single year, or TRENDS to watch the balance between areas shift over time.',
    ...
    notableKicker: 'ONE PER SUBDOMAIN · TOP SCORE, THEN MOST RECENT',
    hasDrill: true,
  },
  orgs: {
    key: 'orgs', label: 'WHO PUBLISHES', chartTitle: 'Research orgs behind safety papers', chartUnit: 'every affiliation counted',
    kicker: 'ORG AFFILIATIONS', big: { num: 55 }, bigUnit: 'orgs', bigLabel: 'organizations have authors on the safety papers',
    brief: 'Who actually produces AI-safety research: the industry labs, university groups, nonprofits and government institutes whose researchers author the papers, together with the philanthropic funders credited in the acknowledgments for supporting the work.',
    stats: [{ k: 'Research orgs', v: '55' }, { k: 'Funders', v: '7' }, { k: 'Top org', v: 'DeepMind · 107' }],
    type: 'orgs',
    note: 'A paper written by researchers from several organizations is counted once for each of them, so the bars add up to more than the number of papers. Switch to PRIMARY to instead credit each paper a single time, to the organization that led the work.',
  },
  papers: {
    ...
    brief: 'Browse all 2,328 safety papers. Search by title or filter by venue, year and research area; each row links to the paper, and expanding one shows the exact reasoning and scores the classifier assigned — so you can check any label for yourself.',
  ...
  implementation: {
    ...
    brief: 'Every accepted paper is read by a reasoning language model (DeepSeek V4 Flash) from its title and abstract alone. For each one it assigns a category, a safety research area, three separate 1–7 scores, a confidence level and a short written justification — with explicit rules to settle the borderline cases.',
